" Vim color file
" Name:       hexer.vim
" Maintainer: Jan Draws <jan.draws93@gmail.com>
" Homepage:   

" Basically: Basic color theme mostly made up of grayshades, with red
" highlights
" based on 256_noir
"
...
let g:colors_name = "hexer"

if has("gui_running") || &t_Co == 256
    hi Normal cterm=NONE ctermfg=250 ctermbg=16 gui=NONE guifg=#ced1d6 guibg=#23272e
    hi Keyword cterm=NONE ctermfg=255 ctermbg=16 gui=NONE guifg=#e06c75 guibg=#23272e
    hi Constant cterm=NONE ctermfg=252 ctermbg=16 gui=NONE guifg=#d0d0d0 guibg=#23272e
    hi String cterm=NONE ctermfg=245 ctermbg=16 gui=NONE guifg=#ffffff guibg=#23272e
    hi Comment cterm=NONE ctermfg=240 ctermbg=16 gui=NONE guifg=#898d93 guibg=#23272e
    hi Number cterm=NONE ctermfg=196 ctermbg=16 gui=NONE guifg=#e5c07b guibg=#23272e
    hi Error cterm=NONE ctermfg=255 ctermbg=88 gui=NONE guifg=#23272e guibg=#e06c75
    hi ErrorMsg cterm=NONE ctermfg=255 ctermbg=124 gui=NONE guifg=#e5c07b guibg=#af0000
    hi Search cterm=NONE ctermfg=245 ctermbg=236 gui=NONE guifg=#23272e guibg=#e5c07b
    ...
    hi SpellBad cterm=undercurl ctermfg=255 ctermbg=88 gui=undercurl guifg=#000000 guibg=#e5c07b
    hi SpellCap cterm=NONE ctermfg=255 ctermbg=124 gui=NONE guifg=#e5c07b guibg=#af0000
    hi SpellRare cterm=NONE ctermfg=124 ctermbg=16 gui=NONE guifg=#af0000 guibg=#23272e
    hi WildMenu cterm=NONE ctermfg=240 ctermbg=255 gui=NONE guifg=#585858 guibg=#eeeeee
    hi Pmenu cterm=NONE ctermfg=255 ctermbg=240 gui=NONE guifg=#e5c07b guibg=#585858
    hi PmenuThumb cterm=NONE ctermfg=232 ctermbg=240 gui=NONE guifg=#080808 guibg=#585858
    hi SpecialKey cterm=NONE ctermfg=16 ctermbg=255 gui=NONE guifg=#e5c07b guibg=#e5c07b
    hi MatchParen cterm=NONE ctermfg=16 ctermbg=240 gui=NONE guifg=NONE guibg=#e06c75
    hi CursorLine cterm=NONE ctermfg=NONE ctermbg=233 gui=NONE guifg=NONE guibg=#121212
    hi StatusLine cterm=bold,reverse ctermfg=245 ctermbg=16 gui=bold,reverse guifg=#8a8a8a guibg=#23272e
    hi StatusLineNC cterm=reverse ctermfg=236 ctermbg=16 gui=reverse guifg=#303030 guibg=#23272e
    hi Visual cterm=reverse ctermfg=250 ctermbg=16 gui=reverse guifg=#ced1d6 guibg=#23272e
...
highlight! link Operator String
highlight! link Structure Keyword
highlight! link Function String
